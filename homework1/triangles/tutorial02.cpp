...
int main(void)
{
	...
	GLuint RedProgramID = LoadShaders("SimpleVertexShader.vertexshader", "SimpleRedFragmentShader.fragmentshader");
	GLuint GreenProgramID = LoadShaders("SimpleVertexShader.vertexshader", "SimpleGreenFragmentShader.fragmentshader");
